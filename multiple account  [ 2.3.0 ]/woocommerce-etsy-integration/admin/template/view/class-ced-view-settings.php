		...
		<div class="ced_etsy_heading ">
			...
			<div class="ced_etsy_child_element default_modal">
				...
				$instructions = array(
					...
					'Choose the default Shiping profile in <a>Shipping Profiles</a> to be used while listing a product on etsy from woocommerce or you can also create new using <a>Create New</a> button.',
					'To automate the process related to inventory , order and import product sync , enable the features as per requirement in <a>Crons</a>.',
				);
