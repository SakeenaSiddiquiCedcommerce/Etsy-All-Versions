		...
		<div class="ced_etsy_heading">
			...
			<div class="ced_etsy_child_element parent_default default_modal">
				...
				$instructions = array(
					...
					'You can fetch the etsy orders manually by clicking the fetch order button or also you can enable the auto fetch order feature in Crons <a href="' . admin_url( 'admin.php?page=ced_etsy&section=ced-etsy-settings&shop_name=' . $activeShop ) . '">here</a>.',
