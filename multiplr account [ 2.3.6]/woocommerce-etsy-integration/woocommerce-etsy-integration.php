<?php
/**
 * Plugin Name: Etsy Integration for WooCommerce-Multi Account
...
if ( ced_etsy_check_woocommerce_active() ) {
	 ...
	 * @since 2.3.1
	 */
	if ( ! in_array( 'multichannel-by-cedcommerce/multichannel-by-cedcommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
