...
<div class="ced_etsy_child_element parent_default">
	<?php
				...
				$profile_url  = admin_url( 'admin.php?page=ced_etsy&section=profiles-view&shop_name=' . esc_attr( $activeShop ) );
				$instructions = array(
					...
					'Once you map the categories profiles will automatically be created and you can use the <a href="' . esc_url( $profile_url ) . ' target="_blank">Profile</a> in order to override the Global Settings.',
				);
